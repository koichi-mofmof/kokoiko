/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: bd9af6ddbede77db15c9086757e7abe1)
// Runtime types generated with workerd@1.20250604.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    ...
    NEXT_PUBLIC_SUPABASE_URL:
      | "https://typroopuejyfkpkgsjsa.supabase.co"
      | "http://127.0.0.1:54321";
    NEXT_PUBLIC_SUPABASE_ANON_KEY:
      | "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR5cHJvb3B1ZWp5Zmtwa2dzanNhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDU1MzQ1MzksImV4cCI6MjA2MTExMDUzOX0.eRQWfD503iHamBQFFm_hG_YQmOqkwcY4NgJUVocV7ro"
    ...
    // 多通貨対応: 新価格ID（存在すれば優先）
    NEXT_PUBLIC_STRIPE_PRICE_ID_MONTHLY_JPY?: string;
    NEXT_PUBLIC_STRIPE_PRICE_ID_YEARLY_JPY?: string;
    NEXT_PUBLIC_STRIPE_PRICE_ID_MONTHLY_USD?: string;
    NEXT_PUBLIC_STRIPE_PRICE_ID_YEARLY_USD?: string;
    NEXT_PUBLIC_STRIPE_PRICE_ID_MONTHLY_EUR?: string;
    NEXT_PUBLIC_STRIPE_PRICE_ID_YEARLY_EUR?: string;
